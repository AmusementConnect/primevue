                        ...
                        <template v-if="!timeOnly">
                            <div :class="cx('calendarContainer')" v-bind="ptm('calendarContainer')">
                                <div v-for="(month, groupIndex) of months" :key="month.month + month.year" :class="cx('calendar')" v-bind="ptm('calendar')">
                                    ...
                                    <div v-else-if="currentView === 'month'" :class="cx('monthView')" v-bind="ptm('monthView')">
                                        <span
                                    ...
                                    <div v-else-if="currentView === 'year'" :class="cx('yearView')" v-bind="ptm('yearView')">
                                        <span
                ...
                try {
                    if (this.isSingleSelection()) {
                        ...
                        if (value && value.length) {
                            ...
                            if (endDate && !dayjs(endDate).isSame(dayjs(startDate), 'date')) {
