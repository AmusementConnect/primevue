...
`
                    ...
                    modules.esm.push(
                        `
// ${fileName}
export * from 'amusementconnect/${folderName}';
export { default as ${fileName} } from 'amusementconnect/${folderName}';
`
                    );
                }
...
`
                                ...
                                modules.esm.push(
                                    `export * from 'amusementconnect/${folderName}/style';
export { default as ${subFileName} } from 'amusementconnect/${folderName}/style';
`
                                );
                            }
                        }
